    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float c1 = i.normal.x * i.normal.x * tex2D(_XAlbedo, i.wPos.yz * _Scale);
                float c2 = i.normal.y * i.normal.y * tex2D(_YAlbedo, i.wPos.xz * _Scale);
                float c3 = i.normal.z * i.normal.z * tex2D(_ZAlbedo, i.wPos.xy * _Scale);
                fixed4 albedo = c1 + c2 + c3;
